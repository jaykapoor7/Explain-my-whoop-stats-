      ...
      {!r.available ? (
        ...
        <>
          ...
          <Why summary="How is Health Age calculated?">
            It compares your last ~3 weeks of resting heart rate, HRV, sleep and daily activity against rough
            age-expected values, then nudges your calendar age up or down. Lower resting HR and higher HRV read younger;
            short or erratic sleep and low activity read older. This is a deterministic estimate for motivation, not a
            validated clinical measure — and never medical advice.
          </Why>
        </>
      )}
    </Card>
